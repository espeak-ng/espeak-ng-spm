...
/* Define to 1 if you have the `sonic' library (-lsonic). */
#define HAVE_LIBSONIC 1
...
/* Define to 1 if you have the <sonic.h> header file. */
...
#define PACKAGE_STRING "eSpeak NG 1.52-dev"
